    ...
    <form action="{{route('admin.service.update', $service->id)}}" method="POST" enctype="multipart/form-data">
         ...
         <div class="mb-3">       
           ...
           <div class="mb-3">       
               ...
               <input type="text" name="class_icon" placeholder="Name Icon Service" value="{{old('class_icon', $service->class_icon)}}" class="form-control @error('class_icon') is-invalid @enderror">
               @error('class_icon')
                 <small class="invalid-feedback"> {{$message}} </small>
               @enderror
          </div>
